...
public class DownloadReturnValueHandler implements HandlerMethodReturnValueHandler {
    ...
    public boolean supportsReturnType(MethodParameter returnType) {
        try {
            ...
            return null != request && "download".equalsIgnoreCase(request.getParameter("mime")) && !DownloadType.OBJECT.equals(DownloadType.instance(request.getParameter("downloadType"))) && DownloadExecutor.getDataStreamReader() != null;
        } catch (Exception e) {
            return false;
        }
    }
