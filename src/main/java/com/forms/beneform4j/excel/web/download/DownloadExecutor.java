...
public class DownloadExecutor extends DataStreamMapperMethodExecutor {
    ...
    protected boolean isSupport() {
        try {
            ...
            return null != request && "download".equalsIgnoreCase(request.getParameter("mime")) && !DownloadType.OBJECT.equals(DownloadType.instance(request.getParameter("downloadType")));
        } catch (Exception e) {
            return false;
        }
    }
