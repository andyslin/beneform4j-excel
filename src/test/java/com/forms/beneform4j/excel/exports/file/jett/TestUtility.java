...
import com.forms.beneform4j.excel.exports.file.jett.model.County;
import com.forms.beneform4j.excel.exports.file.jett.model.Division;
import com.forms.beneform4j.excel.exports.file.jett.model.Element;
import com.forms.beneform4j.excel.exports.file.jett.model.Employee;
import com.forms.beneform4j.excel.exports.file.jett.model.HyperlinkData;
import com.forms.beneform4j.excel.exports.file.jett.model.Region;
import com.forms.beneform4j.excel.exports.file.jett.model.State;
import com.forms.beneform4j.excel.exports.file.jett.model.Team;
import com.forms.beneform4j.excel.exports.file.jett.model.WorkOrder;
...
/**
 * This utility class supplies beans maps for possibly multiple tests. It also supplies convenience
 * methods for accessing spreadsheet data for testing purposes.
 *
...
public class TestUtility {
    /**
     * Gets a beans map with <code>State</code> beans "california" and "nevada". Each bean in turn
     * is composed of many <code>County</code> beans.
     *
     ...
     * @return A <code>Map</code> of the bean name to the bean value -- the <code>State</code>.
     * @since 0.8.0
     */
    ...
    /**
     * Gets a beans map with "counties" referring to a <code>List</code> of all counties in
    ...
    /**
     * Returns some fictional <code>Counties</code> in a collection known as "county", to test a
     * specific part of implicit collections processing.
     * 
     * @return A <code>Map</code> of beans containing a <code>List</code> of dummy
     *         <code>County</code> objects.
     * @since 0.5.2
     */
    ...
    /**
     * Gets a beans map with a <code>List</code> of division beans, most of which contain
     * <code>Team</code> beans. The name is "divisionsList".
     * 
    ...
    /**
     * Get a beans map with only one <code>Division</code>, determined by the <code>code</code>
     * argument. The name is "division".
     * 
     * @param code Determines with division, 0-7.
     * @return A <code>Map</code> of beans, containing a specific <code>Division</code>.
     */
    ...
    /**
     * Get a beans map with only one <code>Division</code>, determined by the <code>code</code>
     * argument. It is keyed by the given name.
     * 
     * @param code Determines which division, 0-7.
     * @param name This becomes the bean name of the <code>Division</code>.
     * @return A <code>Map</code> of beans, containing a specific <code>Division</code> with the
     *         given name.
     */
    ...
    /**
     * Gets a beans map with a <code>List</code> of 100 dummy division beans, each containing 10
     * <code>Team</code> beans. The name is "divisionsList".
     * 
     * @return A <code>Map</code> of beans containing a <code>List</code> of 100 dummy
     *         <code>Divisions</code>.
     * @since 0.8.0
     */
     ...
     * 
     * @return A <code>Map</code> of beans, containing the <code>List</code> of <code>Teams</code>.
     * @since 0.3.0
     */
    ...
    /**
     * Gets a beans map with <code>HyperlinkData</code> data, exposed as "hyperlinks".
     *
    ...
    /**
     * Gets a beans map with <code>Region</code> data, exposed as "regions". Also exposes "dates" as
     * the list of dates.
     * 
    ...
    /**
     * Gets the string value from a particular <code>Cell</code> on the given <code>Sheet</code>.
     * 
    ...
    /**
     * Gets the boolean value from a particular <code>Cell</code> on the given <code>Sheet</code>.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
     * @param col The 0-based column index.
    ...
    /**
     * Gets the <code>RichTextString</code> value from a particular <code>Cell</code> on the given
     * <code>Sheet</code>.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Gets the numeric value from a particular <code>Cell</code> on the given <code>Sheet</code>.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
     * @param col The 0-based column index.
    ...
    /**
     * Gets the string formula value from a particular <code>Cell</code> on the given
     * <code>Sheet</code>.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Determines whether the <code>Cell</code> on the given <code>Sheet</code> at the given row and
     * column indexes is blank: either it doesn't exist, or it exists and the cell type is blank.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
     * @param col The 0-based column index.
    ...
    /**
     * Gets the <code>Comment</code> value, if any, from a particular <code>Cell</code> on the given
     * <code>Sheet</code>.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Determines whether the <code>CellRangeAddress</code>, representing a "merged region", exists
     * in the given <code>Sheet</code>.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param region A <code>CellRangeAddress</code>.
     * @return <code>true</code> if the given region exists in the given sheet, <code>false</code>
     *         otherwise.
     */
    public static boolean isMergedRegionPresent(Sheet sheet, CellRangeAddress region) {
        ...
        for (int i = 0; i < numMergedRegions; i++) {
            ...
            if (candidate.getFirstRow() == region.getFirstRow() && candidate.getLastRow() == region.getLastRow() && candidate.getFirstColumn() == region.getFirstColumn() && candidate.getLastColumn() == region.getLastColumn()) {
                return true;
            }
        }
        return false;
    ...
    /**
     * Helper method to get an actual <code>Font</code>, regardless of which kind of
     * <code>Workbook</code> it came from.
     * 
     * @param result The result of a call to <code>RichTextStringUtil.getFontAtIndex</code>.
    ...
    /**
     * Returns the cell foreground color, as a hex string, on the given <code>Sheet</code>, at the
    ...
    /**
     * Returns the cell background color, as a hex string, on the given <code>Sheet</code>, at the
     * given row and column indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Returns the cell fill pattern on the given <code>Sheet</code>, at the given row and column
     * indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
     ...
     * 
     * @param workbook The <code>Workbook</code> on which the <code>Font</code> is found.
    ...
    /**
     * Returns the cell bottom border color, as a hex string, on the given <code>Sheet</code>, at
    ...
    /**
     * Returns the cell left border color, as a hex string, on the given <code>Sheet</code>, at the
     * given row and column indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Returns the cell right border color, as a hex string, on the given <code>Sheet</code>, at the
     * given row and column indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Returns the cell top border color, as a hex string, on the given <code>Sheet</code>, at the
     * given row and column indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
     ...
     * @param row The 0-based row index.
     * @param col The 0-based column index.
     * @return The <code>Hyperlink</code>, or <code>null</code> if it doesn't exist.
     * @since 0.5.0
     */
    ...
    /**
     * Returns the <code>Cell</code> (if any), on the given <code>Sheet</code>, at the given row and
     * column indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
    ...
    /**
     * Returns the <code>CellStyle</code> (if any), on the given <code>Sheet</code>, at the given
     * row and column indexes.
     * 
     * @param sheet The <code>Sheet</code>.
     * @param row The 0-based row index.
     * @param col The 0-based column index.
     * @return The <code>CellStyle</code> or <code>null</code> if the cell doesn't exist.
     * @since 0.4.0
     */
